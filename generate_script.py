import os
def write_line_quantification(subject, RMN_path, FDG_path, path_file):
...
def generate_script_pet_quant(output_directory, script_path):
    ...
    for subject in files:
        ...
        if os.path.isdir(nifti_subject):
            ...
            write_line_quantification(subject, RMN_path, PET_path, script_path)
...
if __name__ == '__main__':
    ...
    output_directory = "/home/sol/PET_MRI/Procesado/Procesar"
    output_directory_chart = "/home/sol/PET_MRI/Procesado"
